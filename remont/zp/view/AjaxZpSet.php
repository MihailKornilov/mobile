...
if($zp_count>0) $VK->Query("insert zp_available (ws_id,zp_catalog_id,count) values (".$vku->ws_id.",".$zp_id.",".$zp_count.")");
...
if($_POST['zayav_id']>0) {
  ...
  $txt = "Установка запчасти: <A href='".$URL."&my_page=remZpView&id=".$_POST['zp_id']."'>".$name." ".$vendor." ".$model."</A>";
