...
b="";"1"!=a.status&&(a.finish="0000-00-00");"1"!=a.sort&&(b+=".sort="+a.sort);"0"!=a.desc&&(b+=".desc="+a.desc);a.find?b+=".find="+escape(a.find):(0<a.status&&(b+=".status="+a.status),"0000-00-00"!=a.finish&&(b+=".finish="+a.finish),0<a.diff&&(b+=".diff="+a.diff),0<a.zpzakaz&&(b+=".zpzakaz="+a.zpzakaz),0<a.executer&&(b+=".executer="+a.executer),0<a.device&&(b+=".device="+a.device),0<a.vendor&&(b+=".vendor="+a.vendor),0<a.model&&(b+=".model="+a.model),0!=a.place&&(b+=".place="+a.place));VK.callMethod("setLocation",
hashLoc+b);_cookie("zayav_find",escape(a.find));_cookie("zayav_sort",a.sort);_cookie("zayav_desc",a.desc);_cookie("zayav_status",a.status);_cookie("zayav_finish",a.finish);_cookie("zayav_diff",a.diff);_cookie("zayav_zpzakaz",a.zpzakaz);_cookie("zayav_executer",a.executer);_cookie("zayav_device",a.device);_cookie("zayav_vendor",a.vendor);_cookie("zayav_model",a.model);_cookie("zayav_place",escape(a.place));return a},zayavSpisok=function(){var a=zayavFilter();$(".condLost")[(a.find?"add":"remove")+
"Class"]("hide");$("#mainLinks").addClass("busy");$.post(AJAX_WS,a,function(a){$(".result").html(a.all);$("#spisok").html(a.html);$("#mainLinks").removeClass("busy")},"json")},zayavMoneyUpdate=function(){$.post(AJAX_WS,{op:"zayav_money_update",zayav_id:ZAYAV.id},function(a){a.success&&($("b.acc").html(a.acc),$(".acc_tr")[(a.acc?"remove":"add")+"Class"]("dn"),$("b.op").html(a.opl),$(".op_tr")[(a.opl?"remove":"add")+"Class"]("dn"),$(".dopl")[(a.diff?"remove":"add")+"Class"]("dn").html((0<a.diff?"+":
"")+a.diff),$(".ze-spisok").remove(),$("#ze_acc").html(a.acc_sum).after(a.html),ZAYAV.expense=a.array,ZAYAV.worker_zp=a.worker_zp)},"json")},zayavDevSelect=function(a){modelImageGet(a);0==a.device_id?($(".equip_spisok").html(""),$(".tr_equip").addClass("dn")):0==a.vendor_id&&0==a.model_id&&$.post(AJAX_WS,{op:"equip_check_get",device_id:a.device_id},function(a){a.spisok?($(".equip_spisok").html(a.spisok),$(".tr_equip").removeClass("dn")):($(".equip_spisok").html(""),$(".tr_equip").addClass("dn"))},
"json")},zayavPlace=function(a){void 0==a&&(a="");window.PLACE_OTHER||(DEVPLACE_SPISOK.push({uid:0,title:'другое: <input type="text" id="place_other" '+(a?"":'class="dn" ')+'maxlength="20" value="'+a+'" />'}),window.PLACE_OTHER=1);$("#place")._radio({spisok:DEVPLACE_SPISOK,light:1,func:function(a){$("#place_other")[(0!=a?"add":"remove")+"Class"]("dn");0==a&&$("#place_other").val("").focus()}})},kvitHtml=function(a){window.open(APP_HTML+"/view/kvit_html.php?"+VALUES+"&id="+a,"kvit","scrollbars=yes,resizable=yes,status=no,location=no,toolbar=no,menubar=no,width=680,height=500,left=20,top=20")},
cartridgeNew=function(a,b){function c(){var c={op:"cartridge_new",name:$("#name").val(),cost_filling:_num($("#cost_filling").val()),cost_restore:_num($("#cost_restore").val()),cost_chip:_num($("#cost_chip").val()),from:$("#setup-service-cartridge").length?"setup":""};c.name?(f.process(),$.post(AJAX_WS,c,function(d){d.success?("setup"==c.from?$("#spisok").html(d.spisok):(CARTRIDGE_SPISOK=d.spisok,$("#"+a)._select(d.spisok),$("#"+a)._select(d.insert_id),b(d.insert_id)),f.close(),_msg("Внесено!")):f.abort()},
"json")):(f.err("Не указано наименование"),$("#name").focus())}$(this);var f=_dialog({top:20,head:"Добавление нового картриджа",content:'<table id="cartridge-new-tab"><tr><td class="label"><b>Модель картриджа:</b><td><input type="text" id="name" /><tr><td class="label r">Заправка:<td><input type="text" id="cost_filling" class="money" maxlength="11" /> руб.<tr><td class="label r">Восстановление:<td><input type="text" id="cost_restore" class="money" maxlength="11" /> руб.<tr><td class="label r">Замена чипа:<td><input type="text" id="cost_chip" class="money" maxlength="11" /> руб.</table>',
...
submit:c});$("#vaname").focus().keyEnter(c)},a.model_funcAdd=function(){q=_dialog({width:300,head:"Добавление нoвой модели",content:'<table class="device-add-tab"><tr><td class="label">Название:<td><input type="text" id="maname"></table>',submit:f,focus:"#model_name"});$("#maname").focus().keyEnter(f)});t._select({width:a.width,block:1,title0:["Устройство не выбрано","Любое устройство"][a.type_no],spisok:DEV_SPISOK,func:function(b){s.val(0);r.val(0)._select("remove");b?d(0):s._select("remove");a.func(m())},
funcAdd:a.device_funcAdd,bottom:3});a.device_id&&d()};
$.fn.zayavExpense=function(a){function b(a){a||(a=[0,"",""]);var c=f+e,d=c+"cat",p=c+"worker",l=c+"zp";u.append('<table id="ptab'+e+'" class="ptab" val="'+e+'"><tr><td><input type="hidden" id="'+d+'" value="'+a[0]+'" /><td class="tddop">'+(a[0]&&ZE_TXT[a[0]]?'<input type="text" class="zetxt" placeholder="описание не указано" tabindex="'+(10*e-1)+'" value="'+a[1]+'" />':"")+(a[0]&&ZE_WORKER[a[0]]?'<input type="hidden" id="'+p+'" value="'+a[1]+'" />':"")+(a[0]&&ZE_ZP[a[0]]?'<input type="hidden" id="'+
l+'" value="'+a[1]+'" />':"")+'<td class="tdsum'+(a[0]?"":" dn")+'"><input type="text" class="zesum" maxlength="6" tabindex="'+10*e+'" value="'+a[2]+'" />руб.</table>');var m=$("#ptab"+e),h=m.find(".tddop"),g=m.find(".zesum");$("#"+d)._select({width:130,disabled:0,title0:"Категория",spisok:ZE_SPISOK,func:function(a){m.find(".tdsum")[(a?"remove":"add")+"Class"]("dn");ZE_TXT[a]?(h.html('<input type="text" class="zetxt" placeholder="описание не указано" tabindex="'+(10*e-11)+'" />'),h.find(".zetxt").focus()):
...
$.fn.cartridge=function(a){function b(a){f.append('<input type="hidden" class="icar" id="car'+e+'" '+(a?'value="'+a+'" ':"")+"/>");$("#car"+e)._select({width:170,bottom:4,title0:"картридж не выбран",write:1,spisok:CARTRIDGE_SPISOK,func:c,funcAdd:function(a){cartridgeNew(a,c)}})}function c(a){if(a){a=f.find(".icar");for(d=0;d<a.length;d++)if(0==a.eq(d).val())return;e++;b()}}var f=$(this);f.attr("id");var e=1,d;if("string"==typeof a&&"get"==a){a=f.find(".icar");var g=[],p;for(d=0;d<a.length;d++)p=a.eq(d).val(),
0!=p&&g.push(p);return g.join()}if("object"==typeof a)for(g=0;g<a.length;g++)b(a[g]),e++;b()};
$(document).keydown(function(a){function b(){scannerWord="";scannerTime=0;scannerTimer&&clearTimeout(scannerTimer);scannerTimer=void 0;scannerDialogShow=!1}if(!scannerDialogShow)if(13==a.keyCode){var c=(new Date).getTime()-scannerTime;if(5<scannerWord.length&&300>c){scannerDialogShow=!0;scannerTimer=setTimeout(b,500);scannerDialog=_dialog({head:"Сканер штрих-кода",width:250,content:"Получен код: <b>"+scannerWord+"</b>",butSubmit:"Поиск"});var f={op:"scanner_word",word:scannerWord};scannerDialog.process();
$.post(AJAX_WS,f,function(b){if(b.success)if("input"==a.target.localName)scannerDialog.close();else if("zayav"==_cookie("p")&&"add"==_cookie("d"))$("#"+(b.imei?"imei":"serial")).val(f.word),scannerDialog.close();else if(b.zayav_id)document.location.href=URL+"&p=zayav&d=info&id="+b.zayav_id;else{var c="client"==_cookie("p")&&"info"==_cookie("d")?_cookie("id"):0;document.location.href=URL+"&p=zayav&d=add&"+(b.imei?"imei":"serial")+"="+f.word+(c?"&back=client&id="+c:"")}else scannerDialog.abort()},"json")}}else scannerDialog&&
...
if(!a.hasClass("_busy")){a.next(".zayavNomerTab").remove().end().addClass("_busy");var b={op:"zayav_nomer_info",nomer:a.val()};$.post(AJAX_WS,b,function(b){a.removeClass("_busy");b.success&&a.after(b.html)},"json")}}).on("click",".day-finish-link",function(a){a.stopPropagation();var b=$(this),c=b.hasClass("no-save")?0:1;if(!b.hasClass("_busy")){var f=_dialog({top:40,width:480,head:"Календарь ремонтов",load:1,butSubmit:""}),e={op:"zayav_day_finish",day:$("#day_finish").val(),zayav_spisok:$("#zayav").length};
$.post(AJAX_WS,e,function(a){a.success?f.content.html(a.html):f.loadError()},"json");$(document).off("click","#zayav-finish-calendar td.d:not(.old),#fc-cancel,.fc-old-sel").on("click","#zayav-finish-calendar td.d:not(.old),#fc-cancel,.fc-old-sel",function(){b.hasClass("_busy")||(f.close(),b.addClass("_busy"),e={op:"zayav_day_finish_save",day:$(this).attr("val"),zayav_id:window.ZAYAV?ZAYAV.id:0,save:c},$.post(AJAX_WS,e,function(a){b.removeClass("_busy");a.success&&(b.prev("input").val(e.day),b.find("span").html(a.data),
...
butSubmit:"Сохранить",submit:function(){var b,c={op:"zayav_edit",zayav_id:ZAYAV.id,client_id:$("#client_id").val(),device:$("#dev_device").val(),vendor:$("#dev_vendor").val(),model:$("#dev_model").val(),imei:$.trim($("#imei").val()),serial:$.trim($("#serial").val()),color_id:$("#color_id").val(),color_dop:$("#color_dop").val(),equip:"",pre_cost:$("#pre_cost").val()};if(!$(".tr_equip").hasClass("dn")){for(var f=$(".equip_spisok input"),e=[],d=0;d<f.length;d++){var g=f.eq(d);1==g.val()&&e.push(g.attr("id").split("_")[1])}c.equip=
...
width:200,top:-83,left:-2,delayShow:1500});$("#dev").device({width:190,device_id:ZAYAV.device,vendor_id:ZAYAV.vendor,model_id:ZAYAV.model,add:1,func:zayavDevSelect});modelImageGet();imageSortable();colorSelDop(ZAYAV.color_id)}).on("click","#zayav-info .schet-add",function(){function a(){for(var c="<tr><th>№<th>Наименование товара<th>Кол-во<th>Цена<th>Сумма<th>",f=0,l=0;l<e.length;l++)var h=e[l],g=h.cost*h.count,c=c+('<tr><td class="td-n">'+(l+1)+'<td class="td-name">'+h.name+'<td class="td-count">'+
h.count+'<td class="td-cost">'+h.cost+'<td class="td-sum">'+g+"<td>"+(h.del?'<div val="'+l+'" class="img_del pole-del'+_tooltip("Удалить",-29)+"</div>":"")),f=f+g;d=l+1;c+='<tr><td colspan="6" class="_next" id="pole-add">Добавить позицию для счёта';$("#schet-tab").html(c);$("#itog").html("Всего наименований "+l+", на сумму "+f+" руб.");$("#pole-add").click(b);$(".pole-del").click(function(){e.splice(_num($(this).attr("val")),1);a()})}function b(){var a=$(this),b='<tr id="tr-add"><td class="td-n">'+
d+'<td class="td-name"><input type="text" id="name" /><td class="td-count"><input type="text" id="count" value="1" /><td class="td-cost"><input type="text" id="cost" /><td><div class="vkButton"><button>OK</button></div><td><div class="img_del'+_tooltip("Отменить",-32)+"</div>";a.parent().hide();$("#schet-tab").append(b);$("#name").focus();$("#tr-add .img_del").click(function(){$("#tr-add").remove();a.parent().show()});$("#tr-add .vkButton").click(c)}function c(){var b=$.trim($("#name").val()),c=_num($("#count").val()),
d=_num($("#cost").val());b?c?d?(e.push({name:b,count:c,cost:d,del:1}),a()):(f("Некорректное количество"),$("#cost").focus()):(f("Некорректная сумма"),$("#count").focus()):(f("Не указано наименование"),$("#name").focus())}function f(a){$("#name").vkHint({msg:'<span class="red">'+a+"</span>",remove:1,indent:40,show:1,top:-58,left:404})}$(this);var e,d,g=_dialog({top:20,width:580,head:"Формирование счёта",load:1,butSubmit:"Сформировать",submit:function(){var a={op:"zayav_cartridge_schet_add",zayav_id:ZAYAV.id,
spisok:e,date_create:$("#date_create").val(),dop:_num($("#dop").val()),acc:_num($("#acc").val())};a.spisok.length?a.dop?(g.process(),$.post(AJAX_WS,a,function(a){a.success?($("#cart-tab").html(a.cart),$("#schet-spisok").html(a.schet),$("#money_spisok").html(a.acc),g.close(),_msg("Новый счёт сформирован")):g.abort()},"json")):g.err("Выберите дополнительный документ"):g.err("Не добавлено ни одной позиции")}});$.post(AJAX_WS,{op:"zayav_cartridge_schet_load",zayav_id:ZAYAV.id},function(b){b.success?(e=
b.spisok,g.content.html('<div id="schet-add-tab"><table class="_spisok" id="schet-tab"></table><div id="itog"></div><table id="sa-tab"><tr><td class="label r">Дата:<td><input id="date_create" type="hidden" /><tr><td class="label r topi">Приложения:<td><input id="dop" type="hidden" /><tr><td><td><input id="acc" type="hidden" /></table></div>'),a(),$("#date_create")._calendar({lost:1}),$("#dop")._radio({light:1,spisok:[{uid:1,title:"Накладная"},{uid:2,title:"Акт выполненных работ"}]}),$("#acc")._check({name:"Произвести начисление по счёту"})):
g.loadError()},"json")}).on("click","#zayav-info .acc_add",function(){function a(){var a,f={op:"zayav_accrual_add",zayav_id:ZAYAV.id,sum:$("#sum").val(),prim:$("#prim").val(),status:$("#acc_status").val(),remind:$("#acc_remind").val(),remind_txt:$("#reminder_txt").val(),remind_day:$("#reminder_day").val()};REGEXP_NUMERIC.test(f.sum)?1!=f.remind||f.remind_txt?(b.process(),$.post(AJAX_WS,f,function(a){b.abort();a.success&&(b.close(),_msg("Начисление успешно произведено!"),$("#money_spisok").html(a.html),
zayavMoneyUpdate(),a.status&&($("#status").html(a.status.name).css("background-color","#"+a.status.color),$("#status_dtime").html(a.status.dtime)),a.remind&&$("#remind-spisok").html(a.remind))},"json")):(a="Не указан текст напоминания",$("#reminder_txt").focus()):(a="Некорректно указана сумма.",$("#sum").focus());a&&b.bottom.vkHint({msg:'<SPAN class="red">'+a+"</SPAN>",top:-48,left:123,indent:40,remove:1,show:1})}var b=_dialog({top:60,width:420,head:"Заявка №"+ZAYAV.nomer+" - Начисление за выполненную работу",
...
(a+=CARTRIDGE_RESTORE[b]);1==$("#chip").val()&&(a+=CARTRIDGE_CHIP[b]);$("#cost").val(a)}for(var b=$(this);"TR"!=b[0].tagName;)b=b.parent();var c=b.attr("val"),f=b.find(".cart_id").val(),e=b.find(".filling").val(),d=b.find(".restore").val(),g=b.find(".chip").val(),p=b.find(".cost").html(),b=b.find("u").html(),m=_dialog({width:470,top:30,head:"Действия по картриджу",content:'<table id="cart-edit-tab"><tr><td class="label">Картридж:<td><input type="hidden" id="cart_id" value="'+f+'" /><tr><td class="label topi">Действие:<td><input type="hidden" id="filling" value="'+
e+'" /><input type="hidden" id="restore" value="'+d+'" /><input type="hidden" id="chip" value="'+g+'" /><tr><td class="label">Стоимость работ:<td><input type="text" class="money" id="cost" value="'+p+'" /> руб.<tr><td class="label">Примечание:<td><input type="text" id="prim" value="'+b+'" /></table>',butSubmit:"Сохранить",submit:function(){var a={op:"zayav_info_cartridge_edit",id:c,cart_id:_num($("#cart_id").val()),filling:$("#filling").val(),restore:$("#restore").val(),chip:$("#chip").val(),cost:$("#cost").val(),
...
b,function(b){b.success?(zayavMoneyUpdate(),a.close(),_msg("Сохранено.")):a.abort()},"json"))}});$("#zes").zayavExpense(ZAYAV.expense)}));$("#zayav-cartridge").length&&($("#sort")._radio(cartridgeSpisok),$("#desc")._check(cartridgeSpisok),$("#status").rightLink(cartridgeSpisok),$("#paytype")._radio(cartridgeSpisok),$("#noschet")._check(cartridgeSpisok))});
