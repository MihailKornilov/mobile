...
"json")},expenseSpisok=function(){var a={op:"expense_spisok",category:$("#category").val(),worker:$("#worker").val(),year:$("#year").val(),month:$("#monthSum").val()};$("#mainLinks").addClass("busy");$.post(AJAX_WS,a,function(a){$("#mainLinks").removeClass("busy");a.success&&($("#spisok").html(a.html),$("#monthList").html(a.mon))},"json")};
...
REGEXP_CENA.test(a.sum)?window.ZAYAV||a.prim?(c.process(),$.post(AJAX_WS,a,function(a){a.success&&(c.close(),_msg("Новое платёж внесён."),window.ZAYAV?$("#money_spisok").html(a.html):incomeSpisok())},"json")):(b("Не указано описание"),$("#prim").focus()):(b("Некорректно указана сумма"),$("#sum").focus())}function b(a){c.bottom.vkHint({msg:'<SPAN class="red">'+a+"</SPAN>",remove:1,indent:40,show:1,top:-47,left:103})}var c=_dialog({width:380,head:"Внесение платежа",content:'<TABLE id="income-add-tab"><input type="hidden" id="zayav_id" value="'+
(window.ZAYAV?ZAYAV.id:0)+'" />'+(window.ZAYAV?'<tr><td class="label">Заявка:<td><b>№'+ZAYAV.nomer+"</b>":"")+'<tr><td class="label">Вид платежа:<td><input type="hidden" id="income_id" value="'+(1==INCOME_SPISOK.length?INCOME_SPISOK[0].uid:0)+'" /><tr><td class="label">Сумма:<td><input type="text" id="sum" class="money" maxlength="11" /> руб.<tr><td class="label">Описание:<td><input type="text" id="prim" maxlength="100" /></TABLE>',submit:a});$("#income_id")._select({width:218,title0:"Не выбран",
spisok:INCOME_SPISOK,func:function(){$("#sum").focus()}});$("#sum").focus();$("#sum,#prim").keyEnter(a)}).on("click",".income-del",function(){for(var a=$(this);"TR"!=a[0].tagName;)a=a.parent();if(!a.hasClass("deleting")){a.addClass("deleting");var b={op:"income_del",id:a.attr("val")};$.post(AJAX_WS,b,function(b){a.removeClass("deleting");b.success&&a.addClass("deleted")},"json")}}).on("click",".income-rest",function(){for(var a=$(this);"TR"!=a[0].tagName;)a=a.parent();var b={op:"income_rest",id:a.attr("val")};
...
c+"</SPAN>",top:-48,left:201,indent:30,remove:1,show:1,correct:0})}}));$("#zayavInfo").length&&($(".delete").vkHint({msg:"Заявку можно удалить при отсутствии платежей и начислений. Также удаляются все задачи к этой заявке.",width:150,ugol:"top",top:40,left:456,indent:90,correct:0}),$(".fotoUpload").fotoUpload({owner:"zayav"+ZAYAV.id,func:zayavImgUpdate}),$(".img_print").click(function(){_dialog({width:380,top:30,head:"Заявка №"+ZAYAV.nomer+" - Печать квитанции",content:'<table class="zayav-print"><tr><td class="label">Дата приёма:<td>'+
...
a+"</span>",top:-47,left:92,indent:50,show:1,remove:1})}$(this);var d=_dialog({width:350,head:"Перевод между счетами",content:'<table class="_dialog-tab"><tr><td class="label">Со счёта:<td><input type="hidden" id="from" /><tr><td class="label">На счёт:<td><input type="hidden" id="to" /><tr><td class="label">Сумма:<td><input type="text" id="sum" class="money" /> руб. <tr><td class="label">Комментарий:<td><input type="text" id="about" /></table>',butSubmit:"Применить",submit:a});if(window.W_GETMONEY&&
!window.CSMOVE){for(n=0;n<W_GETMONEY.length;n++)INVOICE_SPISOK.push(W_GETMONEY[n]);window.CSMOVE=1}$("#from")._select({width:218,title0:"Не выбран",spisok:INVOICE_SPISOK});$("#to")._select({width:218,title0:"Не выбран",spisok:INVOICE_SPISOK});$("#sum,#about").keyEnter(a)})});
