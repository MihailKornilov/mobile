...
function(){var a={op:"expense_del",id:$(this).attr("val")},b=$(this).parent().parent();b.html('<td colspan="4" class="deleting">Удаление... <img src=/img/upload.gif></td>');$.post(AJAX_WS,a,function(a){a.success&&(_msg("Удаление произведено."),b.remove())},"json")}).ready(function(){$("#client").length&&(window.cFind=$("#find")._search({width:602,focus:1,enter:1,txt:"Начните вводить данные клиента",func:clientSpisok}),$("#buttonCreate").vkHint({msg:'<B>Внесение нового клиента в базу.</B><br /><br />После внесения Вы попадаете на страницу с информацией о клиенте для дальнейших действий.<br /><br />Клиентов также можно добавлять при <A href="'+
