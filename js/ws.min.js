...
id:$(this).attr("val")},b=$(this).parent().parent(),c=b.html();b.html('<td colspan="4" class="deleting">Восстановление... <img src=/img/upload.gif></td>');$.post(AJAX_WS,a,function(a){a.success&&(_msg("Восстановление произведено."),b.removeClass("deleted").html(c).find(".img_rest").attr("class","img_del").attr("title","Удалить платёж"),$("#kassa_summa").html(a.sum))},"json")}).on("click","#kassaShowDel_check",reportKassaLoad).ready(function(){$("#client").length&&(window.cFind=$("#find")._search({width:602,
focus:1,enter:1,txt:"Начните вводить данные клиента",func:clientSpisok}),$("#buttonCreate").vkHint({msg:'<B>Внесение нового клиента в базу.</B><br /><br />После внесения Вы попадаете на страницу с информацией о клиенте для дальнейших действий.<br /><br />Клиентов также можно добавлять при <A href="'+URL+'&p=zayav&d=add&back=client">создании новой заявки</A>.',ugol:"right",width:215,top:-38,left:-250,indent:40,delayShow:1E3,correct:0}).click(clientAdd),$("#dolg")._check(clientSpisok),$("#active")._check(clientSpisok),
$("#comm")._check(clientSpisok),$("#dolg_check").vkHint({msg:"<b>Список должников.</b><br /><br />Выводятся клиенты, у которых баланс менее 0. Также в результате отображается общая сумма долга.",ugol:"right",width:150,top:-6,left:-185,indent:20,delayShow:1E3,correct:0}));$("#clientInfo").length&&($("#dopLinks .link").click(function(){$("#dopLinks .link").removeClass("sel");$(this).addClass("sel");var a=$(this).attr("val");$(".res").css("display","zayav"==a?"block":"none");$("#zayav_filter").css("display",
"zayav"==a?"block":"none");$("#zayav_spisok").css("display","zayav"==a?"block":"none");$("#money_spisok").css("display","money"==a?"block":"none");$("#remind_spisok").css("display","remind"==a?"block":"none");$("#comments").css("display","comm"==a?"block":"none");$("#histories").css("display","hist"==a?"block":"none")}),$("#status").rightLink(clientZayavSpisok),$("#diff")._check(clientZayavSpisok),$("#dev").device({width:145,type_no:1,device_ids:DEVICE_IDS,vendor_ids:VENDOR_IDS,model_ids:MODEL_IDS,
func:clientZayavSpisok}));if($("#zayav").length){window.zFind=$("#find").vkHint({msg:"Поиск производится по<br />совпадению в названии<br />модели, imei и серийном<br />номере.",ugol:"right",top:-9,left:-178,delayShow:800,correct:0})._search({width:153,focus:1,txt:"Быстрый поиск...",enter:1,func:zayavSpisokLoad});zFind.inp(G.zayav_find);$("#desc")._check(zayavSpisokLoad);$("#status").rightLink(zayavSpisokLoad);$("#diff")._check(zayavSpisokLoad);$("#dev").device({width:155,type_no:1,device_id:G.zayav_device,
vendor_id:G.zayav_vendor,model_id:G.zayav_model,device_ids:DEVICE_IDS,vendor_ids:VENDOR_IDS,model_ids:MODEL_IDS,func:zayavSpisokLoad});for(n=0;n<G.place_other.length;n++){var a=G.place_other[n];DEVPLACE_SPISOK.push({uid:encodeURI(a),title:a})}DEVPLACE_SPISOK.push({uid:-1,title:"не известно",content:"<B>не известно</B>"});$("#device_place")._select({width:155,title0:"Любое местонахождение",spisok:DEVPLACE_SPISOK,func:zayavSpisokLoad});DEVSTATUS_SPISOK.splice(0,1);DEVSTATUS_SPISOK.push({uid:-1,title:"не известно",
content:"<B>не известно</B>"});$("#devstatus")._select({width:155,title0:"Любое состояние",spisok:DEVSTATUS_SPISOK,func:zayavSpisokLoad});zayavFilter()}$("#zayavAdd").length&&($("#client_id").clientSel({add:1}),$("#dev").device({width:190,add:1,device_ids:WS_DEVS,func:zayavDevSelect}),DEVPLACE_SPISOK.push({uid:0,title:'другое: <input type="text" id="place_other" class="dn" maxlength="20" />'}),$("#place")._radio({spisok:DEVPLACE_SPISOK,func:function(a){$("#place_other")[(0!=a?"add":"remove")+"Class"]("dn");
0==a&&$("#place_other").val("").focus()}}),colorSelDop(0),$(document).on("click","#fault",function(){for(var a=$(this).find("INPUT"),c=[],d=0;d<a.length;d++)if(1==a.eq(d).val()){var e=a.eq(d).attr("id").split("_")[1];c.push(FAULT_ASS[e])}$("#comm").val(c.join(", "))}),$("#comm").autosize(),$("#reminder_check").click(function(a){$("#reminder_tab").toggle();$("#reminder_txt").focus()}),$("#reminder_day")._calendar(),$(".vkCancel").click(function(){location.href=URL+"&p="+$(this).attr("val")}),$(".vkButton").click(function(){if(!$(this).hasClass("busy")){var a=
