...
"_zayav_diagnost",a.diagnost);_cookie(VIEWER_ID+"_zayav_place",escape(a.place));return a},zayavSpisok=function(a,b){_filterSpisok(ZAYAV,a,b);$(".condLost")[(ZAYAV.find?"add":"remove")+"Class"]("hide");$.post(AJAX_MAIN,ZAYAV,function(a){a.success&&($(".result").html(a.all),$("#spisok").html(a.spisok))},"json")},zayavDevSelect=function(a){modelImageGet(a);0==a.device_id?($(".equip_spisok").html(""),$(".tr_equip").addClass("dn")):0==a.vendor_id&&0==a.model_id&&$.post(AJAX_MAIN,{op:"equip_check_get",
device_id:a.device_id},function(a){a.spisok?($(".equip_spisok").html(a.spisok),$(".tr_equip").removeClass("dn")):($(".equip_spisok").html(""),$(".tr_equip").addClass("dn"))},"json")},zayavPlace=function(a){window.PLACE_OTHER||(DEVPLACE_SPISOK.push({uid:0,title:'<div id="place-other-div">другое:<input type="text" id="place_other" class="dn" /></div>'}),window.PLACE_OTHER=1);$("#place")._radio({spisok:DEVPLACE_SPISOK,light:1,func:function(b){$("#place_other")[(b?"add":"remove")+"Class"]("dn");b||$("#place_other").val("").focus();
"function"==typeof a&&a()}})},zayavKvit=function(){var a=_dialog({width:380,top:30,head:"Заявка №"+ZAYAV.nomer+" - Формирование квитанции",content:'<table class="zayav-print"><tr><td class="label">Дата приёма:<td>'+PRINT.dtime+'<tr><td class="label top">Устройство:<td>'+PRINT.device+'<tr><td class="label">Цвет:<td>'+(PRINT.color?PRINT.color:"<i>не указан</i>")+'<tr><td class="label">IMEI:<td>'+(PRINT.imei?PRINT.imei:"<i>не указан</i>")+'<tr><td class="label">Серийный номер:<td>'+(PRINT.serial?PRINT.serial:
"<i>не указан</i>")+'<tr><td class="label">Комплектация:<td>'+(PRINT.equip?PRINT.equip:"<i>не указана</i>")+'<tr><td class="label">Заказчик:<td><b>'+PRINT.client+'</b><tr><td class="label">Телефон:<td>'+(PRINT.telefon?PRINT.telefon:"<i>не указан</i>")+'<tr><td class="label top">Неисправность:<td><textarea id="defect">'+PRINT.defect+'</textarea><tr><td colspan="2"><a id="preview"><span>Предварительный просмотр квитанции</span></a></table>',butSubmit:"Сохранить квитанцию",submit:function(){var b={op:"zayav_kvit",
zayav_id:ZAYAV.id,defect:$.trim($("#defect").val()),active:1};b.defect?(a.process(),$.post(AJAX_MAIN,b,function(b){b.success?(a.close(),_msg("Квитанция сохранена"),$("#kvit_spisok").html(b.html)):a.abort()},"json")):a.err("Не указана неисправность")}});$("#defect").focus().autosize();$("#preview").click(function(){var b=$(this),c={op:"zayav_kvit",zayav_id:ZAYAV.id,defect:$.trim($("#defect").val())};b.hasClass("_busy")||(c.defect?(b.addClass("_busy"),$.post(AJAX_MAIN,c,function(a){b.removeClass("_busy");
a.success&&kvitHtml(a.id)},"json")):a.err("Не указана неисправность"))})},kvitHtml=function(a){window.open(APP_HTML+"/view/kvit_html.php?"+VALUES+"&id="+a,"kvit","scrollbars=yes,resizable=yes,status=no,location=no,toolbar=no,menubar=no,width=680,height=500,left=20,top=20")},cartridgeNew=function(a,b){function c(){var c={op:"cartridge_new",type_id:$("#type_id").val(),name:$("#name").val(),cost_filling:_num($("#cost_filling").val()),cost_restore:_num($("#cost_restore").val()),cost_chip:_num($("#cost_chip").val()),
from:$("#setup-service-cartridge").length?"setup":""};c.name?(d.process(),$.post(AJAX_MAIN,c,function(e){e.success?("setup"==c.from?$("#spisok").html(e.spisok):(CARTRIDGE_SPISOK=e.spisok,$("#"+a)._select(e.spisok),$("#"+a)._select(e.insert_id),b(e.insert_id)),d.close(),_msg("Внесено!")):d.abort()},"json")):(d.err("Не указано наименование"),$("#name").focus())}$(this);var d=_dialog({top:20,head:"Добавление нового картриджа",content:'<table id="cartridge-new-tab"><tr><td class="label r">Вид:<td><input type="hidden" id="type_id" value="1" /><tr><td class="label r"><b>Модель картриджа:</b><td><input type="text" id="name" /><tr><td class="label r">Заправка:<td><input type="text" id="cost_filling" class="money" maxlength="11" /> руб.<tr><td class="label r">Восстановление:<td><input type="text" id="cost_restore" class="money" maxlength="11" /> руб.<tr><td class="label r">Замена чипа:<td><input type="text" id="cost_chip" class="money" maxlength="11" /> руб.</table>',
submit:c});$("#type_id")._select({spisok:CARTRIDGE_TYPE});$("#name").focus();$("#name,#cost_filling,#cost_restore,#cost_chip").keyEnter(c)},zayavCartridgeAdd=function(){window.CLIENT||(CLIENT={id:0,name:""});var a=_dialog({width:470,top:30,head:"Новая заявка на заправку картриджей",content:'<table id="cartridge-add-tab"><tr><td class="label">Клиент:<td><input type="hidden" id="client_id" value="'+CLIENT.id+'" /><b>'+CLIENT.name+'</b><tr><td class="label"><b>Количество картриджей:</b><td><input type="text" id="count" /> шт.<tr><td class="label topi">Расчёт:<td><input type="hidden" id="pay_type" /><tr><td class="label topi">Список картриджей:<td id="crt"><tr><td class="label top">Заметка:<td><textarea id="comm"></textarea></table>',
...
a.err("Не указан клиент")}});CLIENT.id||$("#client_id").clientSel({add:1});$("#count").focus();$("#pay_type")._radio({light:1,spisok:PAY_TYPE});$("#crt").cartridge();$("#comm").autosize()},cartridgeSpisok=function(a,b){_filterSpisok(CARTRIDGE,a,b);$.post(AJAX_MAIN,CARTRIDGE,function(a){a.success&&($(".result").html(a.all),$("#spisok").html(a.spisok))},"json")},cartridgeSchetSet=function(a){a={op:"zayav_cartridge_schet_set",schet_id:a,ids:_checkAll()};$.post(AJAX_MAIN,a,function(a){a.success&&location.reload()},
"json")},zayavInfoCartridgeAdd=function(){var a=_dialog({width:470,top:30,head:"Добавление картриджей к заявке",content:'<table id="cartridge-add-tab"><tr><td class="label topi">Список картриджей:<td id="crt"></table>',submit:function(){var b={op:"zayav_info_cartridge_add",zayav_id:ZAYAV.id,ids:$("#crt").cartridge("get")};b.ids?(a.process(),$.post(AJAX_MAIN,b,function(b){b.success?(a.close(),$("#cart-tab").html(b.html),_msg("Внесено.")):a.abort()},"json")):a.err("Не выбрано ни одного картриджа")}});
$("#crt").cartridge()},zayavCartridgeEdit=function(){var a=_dialog({width:470,head:"Редактирование заявки",content:'<table id="cartridge-add-tab"><tr><td class="label">Клиент:<td><input type="hidden" id="client_id" value="'+ZAYAV.client_id+'" /><tr><td class="label"><b>Количество картриджей:</b><td><input type="text" id="count" value="'+ZAYAV.cartridge_count+'" /> шт.<tr><td class="label topi">Расчёт:<td><input type="hidden" id="pay_type" value="'+ZAYAV.pay_type+'" /></table>',butSubmit:"Сохранить",
submit:function(){var b={op:"zayav_cartridge_edit",zayav_id:ZAYAV.id,client_id:_num($("#client_id").val()),count:_num($("#count").val()),pay_type:_num($("#pay_type").val())};b.client_id?b.count?b.pay_type?(a.process(),$.post(AJAX_MAIN,b,function(b){b.success?(a.close(),_msg(),location.reload()):a.abort()},"json")):a.err("Укажите вид расчёта"):a.err("Не указано количество картриджей"):a.err("Не указан клиент")}});$("#client_id").clientSel({add:1});$("#pay_type")._radio({light:1,spisok:PAY_TYPE})},
zpNameSelect=function(a,b){window.ZPNAME||(window.ZPNAME={});ZPNAME.device_id=a;$("#name_id")._select({width:230,funcAdd:a?zpNameAdd:null,title0:a?"Наименование запчасти не выбрано":"Сначала выберите устройство",spisok:ZPNAME_SPISOK[a]})._select(b||0)},zpNameAdd=function(){function a(){var a={op:"zpname_add",device_id:ZPNAME.device_id,name:$("#name").val()};a.name?(b.process(),$.post(AJAX_MAIN,a,function(d){d.success?($(".sa-equip").length?$("#zp-spisok").html(d.zp):(ZPNAME_SPISOK[ZPNAME.device_id].push({uid:d.id,
title:a.name}),$("#name_id")._select(ZPNAME_SPISOK[ZPNAME.device_id])._select(d.id)),b.close(),_msg("Внесено!")):b.abort()},"json")):(b.err("Не указана запчасть"),$("#name").focus())}var b=_dialog({width:390,head:"Добавление нового наименования запчасти",content:'<table id="zpname-add-tab"><tr><td class="label">Устройство:<td><b>'+DEV_ASS[ZPNAME.device_id]+'</b><tr><td class="label">Запчасть:<td><input id="name" type="text" maxlength="100" /></table>',submit:a});$("#name").focus().keyEnter(a)};
...
butSubmit:""});$("#go-device").click(a);$("#cartridge-add").click(function(){d.close();zayavCartridgeAdd()})}else a()}).on("click",".zayav_unit",function(){var a=$(this).attr("val");_scroll("set","u"+a);location.href=URL+"&p=zayav&d=info&id="+a}).on("mouseenter",".zayav_unit",function(){var a=$(this),b=a.find(".note").html();b&&a.vkHint({width:150,msg:b,ugol:"left",top:10,left:a.width()+43,show:1,indent:5,delayShow:500})}).on("click","#zayav .clear",function(){$("#find")._search("clear");$("#sort")._radio(1);
$("#desc")._check(0);$("#status").rightLink(0);$("#day_finish").val("0000-00-00");$(".day-finish-link span").html("не указан");$("#diagnost")._check(0);$("#diff")._check(0);$("#zpzakaz")._radio(0);$("#executer")._select(0);$("#dev").device({width:155,type_no:1,device_ids:Z.device_ids,vendor_ids:Z.vendor_ids,model_ids:Z.model_ids,device_multiselect:1,func:zayavSpisok});$("#place")._select(0);ZAYAV.find="";ZAYAV.sort=1;ZAYAV.desc=0;ZAYAV.status=0;ZAYAV.finish="0000-00-00";ZAYAV.diagnost=0;ZAYAV.diff=
0;ZAYAV.zpzakaz=0;ZAYAV.executer=0;ZAYAV.device=0;ZAYAV.vendor=0;ZAYAV.model=0;ZAYAV.place=0;zayavSpisok()}).on("click","#zayav-info .zedit",zayavEdit).on("click","#zayav-status-button .status_place",function(){var a=_dialog({top:30,width:420,head:"Изменение статуса заявки",content:'<div id="zayav-status">'+(1!=ZAYAV.status?'<div class="st c1" val="1">Ожидает выполнения<div class="about">Возобновление работы по заявке.</div></div>':"")+(2!=ZAYAV.status?'<div class="st c2" val="2">Выполнено<div class="about">Заявка выполнена успешно.<br />Не забудьте расписать расходы по заявке, проверьте начисления.<br />Добавьте напоминание, если необходимо.</div></div>':
...
(a.close(),_msg("Изменения сохранены."),document.location.reload()):a.abort()},"json")):a.err("Выберите статус заявки")}});zayavPlace();$(".st").click(function(){var a=$(this),c=a.attr("val");a.parent().find(".st").hide();a.show();$("#zs-status").val(c);$("#zs-tab").show();1==c&&$("#zs-srok").removeClass("dn")})}).on("click","#zayav-status-button .cartridge_status",function(){function a(){var a={op:"zayav_cartridge_status",zayav_id:ZAYAV.id,status:_num($("#zs-status").val())};b.process();$.post(AJAX_MAIN,
...
a.find(".color").html()+".<br />":"")+"<br />Информация об установке также<br />будет добавлена в заметки<br />и в расходы по заявке.</center>",c=_dialog({top:150,width:400,head:"Установка запчасти",content:b,butSubmit:"Установить",submit:function(){var b={op:"zayav_zp_set",zp_id:a.attr("val"),zayav_id:ZAYAV.id};c.process();$.post(AJAX_MAIN,b,function(a){a.success?(c.close(),_msg("Установка запчасти произведена."),location.reload()):c.abort()},"json")}})}).on("click",".zayav_kvit",function(){kvitHtml($(this).attr("val"))}).on("click",
"#zayav-cartridge .clear",function(){$("#sort")._radio(1);$("#desc")._check(0);$("#status").rightLink(0);$("#paytype")._radio(0);$("#noschet")._check(0);CARTRIDGE.sort=1;CARTRIDGE.desc=0;CARTRIDGE.status=0;CARTRIDGE.paytype=0;CARTRIDGE.noschet=0;cartridgeSpisok()}).on("click","#zayav-cartridge-info #edit",zayavCartridgeEdit).on("click","#zayav-cartridge-info #cart-add",zayavInfoCartridgeAdd).on("click","#zayav-cartridge-info .cart-edit",function(){function a(){var a=0,b=_num($("#cart_id").val());
1==$("#filling").val()&&(a=CARTRIDGE_FILLING[b]);1==$("#restore").val()&&(a+=CARTRIDGE_RESTORE[b]);1==$("#chip").val()&&(a+=CARTRIDGE_CHIP[b]);$("#cost").val(a)}for(var b=$(this);"TR"!=b[0].tagName;)b=b.parent();var c=b.attr("val"),d=b.find(".cart_id").val(),f=b.find(".filling").val(),e=b.find(".restore").val(),h=b.find(".chip").val(),p=b.find(".cost").html(),b=b.find("u").html(),r=_dialog({width:470,top:30,head:"Действия по картриджу",content:'<table id="cart-edit-tab"><tr><td class="label">Картридж:<td><input type="hidden" id="cart_id" value="'+
d+'" /><tr><td class="label topi">Действие:<td><input type="hidden" id="filling" value="'+f+'" /><input type="hidden" id="restore" value="'+e+'" /><input type="hidden" id="chip" value="'+h+'" /><tr><td class="label">Стоимость работ:<td><input type="text" class="money" id="cost" value="'+p+'" /> руб.<tr><td class="label">Примечание:<td><input type="text" id="prim" value="'+b+'" /></table>',butSubmit:"Сохранить",submit:function(){var a={op:"zayav_info_cartridge_edit",id:c,cart_id:_num($("#cart_id").val()),
filling:$("#filling").val(),restore:$("#restore").val(),chip:$("#chip").val(),cost:$("#cost").val(),prim:$("#prim").val()};a.cart_id?(r.process(),$.post(AJAX_MAIN,a,function(a){a.success?(r.close(),$("#cart-tab").html(a.html),_msg("Изменено.")):r.abort()},"json")):r.err("Не выбран картридж")}});$("#cart_id")._select({write:1,spisok:CARTRIDGE_SPISOK,func:a});$("#filling")._check({name:"Заправка",func:a});$("#restore")._check({name:"Восстановление",func:a});$("#chip")._check({name:"Замена чипа",func:a})}).on("click",
"#zayav-cartridge-info .cart-del",function(){for(var a=$(this);"TR"!=a[0].tagName;)a=a.parent();var b=a.attr("val"),c=_dialog({head:"Удаление картриджа",content:"<center>Подтвердите удаление картриджа.</center>",butSubmit:"Удалить",submit:function(){var a={op:"zayav_info_cartridge_del",id:b};c.process();$.post(AJAX_MAIN,a,function(a){a.success?(c.close(),$("#cart-tab").html(a.html),_msg("Удалено.")):c.abort()},"json")}})}).ready(function(){$("#zayav").length&&($("#find").vkHint({msg:"Поиск производится по<br />совпадению в названии<br />модели, imei и серийном<br />номере.",
ugol:"right",top:-9,left:-178,delayShow:800})._search({width:153,focus:1,txt:"Быстрый поиск...",enter:1,func:zayavSpisok}).inp(ZAYAV.find),$("#sort")._radio(zayavSpisok),$("#desc")._check(zayavSpisok),$("#status").rightLink(zayavSpisok),$("#diagnost")._check(zayavSpisok),$("#diff")._check(zayavSpisok),$("#zpzakaz")._radio(zayavSpisok),WORKER_SPISOK.push({uid:-1,title:"Не назначен",content:"<b>Не назначен</b>"}),$("#executer")._select({width:155,title0:"не указан",spisok:WORKER_SPISOK,func:zayavSpisok}),
$("#dev").device({width:155,type_no:1,device_id:ZAYAV.device,vendor_id:ZAYAV.vendor,model_id:ZAYAV.model,device_multiselect:1,device_ids:Z.device_ids,vendor_ids:Z.vendor_ids,model_ids:Z.model_ids,func:function(a){ZAYAV.device=a.device_id;ZAYAV.vendor=a.vendor_id;ZAYAV.model=a.model_id;zayavSpisok()}}),$("#place")._select({width:155,title0:"Любое местонахождение",spisok:DEVPLACE_SPISOK,func:zayavSpisok}));$("#zayavAdd").length&&($("#client_id").clientSel({add:1}),$("#dev").device({width:190,add:1,
device_ids:WS_DEVS,func:zayavDevSelect}),zayavPlace(),_valueColors(0),$("#comm").autosize(),$(".vkCancel").click(function(){location.href=URL+"&p="+$(this).attr("val")}),$(".vkButton").click(function(){var a=$(this),b={op:"zayav_add",client_id:$("#client_id").val(),device:$("#dev_device").val(),vendor:$("#dev_vendor").val(),model:$("#dev_model").val(),equip:"",place:$("#place").val(),place_other:$("#place_other").val(),imei:$("#imei").val(),serial:$("#serial").val(),color:$("#color_id").val(),color_dop:$("#color_dop").val(),
diagnost:$("#diagnost").val(),comm:$("#comm").val(),pre_cost:$("#pre_cost").val(),day_finish:$("#day_finish").val()};if(!a.hasClass("busy")){if(!$(".tr_equip").hasClass("dn")){for(var c=$(".equip_spisok input"),d=[],f=0;f<c.length;f++){var e=c.eq(f);1==e.val()&&d.push(e.attr("id").split("_")[1])}b.equip=d.join()}c="";0==b.client_id?c="Не выбран клиент":0==b.device?c="Не выбрано устройство":"-1"==b.place||0==b.place&&!b.place_other?c="Не указано местонахождение устройства":!b.pre_cost||REGEXP_NUMERIC.test(b.pre_cost)&&
0!=b.pre_cost?"0000-00-00"==b.day_finish?c="Не указан срок выполнения ремонта":(0<b.place&&(b.place_other=""),a.addClass("busy"),$.post(AJAX_MAIN,b,function(b){b.success?location.href=URL+"&p=zayav&d=info&id="+b.id:a.removeClass("busy")},"json")):(c="Некорректно указана предварительная стоимость",$("#pre_cost").focus());c&&$(this).vkHint({msg:'<SPAN class="red">'+c+"</SPAN>",top:-48,left:201,indent:30,remove:1,show:1})}}));$("#zayav-info").length&&($(".a-page").click(function(){var a=$(this);a.parent().find(".link").removeClass("sel");
a=a.addClass("sel").index();$(".page:first")[(a?"add":"remove")+"Class"]("dn");$(".page:last")[(a?"remove":"add")+"Class"]("dn")}),$("#zayav-action")._dropdown({head:"Действие",nosel:1,spisok:[{uid:1,title:"Редактировать данные заявки"},{uid:2,title:"<b>Распечатать квитанцию</b>"},{uid:3,title:"Сформировать счёт на оплату"},{uid:5,title:"Начислить"},{uid:6,title:"<b>Принять платёж</b>"},{uid:7,title:"Возврат"},{uid:8,title:"Изменить расходы по заявке"},{uid:9,title:"Новое напоминание"}],func:function(a){switch(a){case 1:zayavEdit();
break;case 2:3==WS_ID?location.href=APP_HTML+"/view/kvit_comtex.php?"+VALUES+"&id="+ZAYAV.id:zayavKvit();break;case 3:_schetEdit({edit:1,client_id:ZAYAV.client_id,client:ZAYAV.client_link,zayav_id:ZAYAV.id});break;case 5:_accrualAdd();break;case 6:_incomeAdd();break;case 7:_refundAdd();break;case 8:_zayavExpenseEdit();break;case 9:_remindAdd()}}}),$("#executer_id")._dropdown({title0:"не указан",spisok:WORKER_SPISOK,func:function(a){var b=$("#executer_td");a={op:"zayav_executer_change",zayav_id:ZAYAV.id,
executer_id:a};b.addClass("_busy");$.post(AJAX_MAIN,a,function(a){b.removeClass("_busy");a.success&&_msg("Исполнитель изменён")},"json")}}),$("#executer_id_dropdown").vkHint({msg:"Сотрудник, который назначен на выполнение данной заявки.",delayShow:1E3,width:150,top:-79,left:-50}),$("#diagnost-ready").click(function(){var a=_dialog({width:450,head:"Внесение результатов диагностики",content:'<div class="_info">После внесения результатов диагностики к заявке будет добавлен комментарий. При необходимости можно добавить напоминание.</div><table class="_dialog-tab" id="zayav-diagnost-tab"><tr><td class="label">Заявка:<td><b>№'+
...
$("#remind-day")._calendar()}));$("#zayav-cartridge").length&&($("#sort")._radio(cartridgeSpisok),$("#desc")._check(cartridgeSpisok),$("#status").rightLink(cartridgeSpisok),$("#paytype")._radio(cartridgeSpisok),$("#noschet")._check(cartridgeSpisok));$("#zayav-cartridge-info").length&&($(".a-page").click(function(){var a=$(this);a.parent().find(".link").removeClass("sel");a=a.addClass("sel").index();$(".page:first")[(a?"add":"remove")+"Class"]("dn");$(".page:last")[(a?"remove":"add")+"Class"]("dn")}),
$("#zayav-action")._dropdown({head:"Действие",nosel:1,spisok:[{uid:1,title:"Редактировать заявку"},{uid:2,title:"<b>Распечатать квитанцию</b>"},{uid:3,title:"Сформировать счёт на оплату"},{uid:5,title:"Начислить"},{uid:6,title:"<b>Принять платёж</b>"},{uid:7,title:"Возврат"},{uid:8,title:"Изменить расходы по заявке"},{uid:9,title:"Новое напоминание"}],func:function(a){switch(a){case 1:zayavCartridgeEdit();break;case 2:3==WS_ID&&(location.href=APP_HTML+"/view/kvit_cartridge.php?"+VALUES+"&id="+ZAYAV.id);
break;case 3:if(!_checkAll()){_schetEdit({edit:1,client_id:ZAYAV.client_id,client:ZAYAV.client_link,zayav_id:ZAYAV.id});break}var b=_dialog({head:"Получение информации о картриджах",load:1,butSubmit:""});a={op:"zayav_cartridge_ids",ids:_checkAll()};$.post(AJAX_MAIN,a,function(a){a.success?(b.close(),_schetEdit({edit:1,client_id:ZAYAV.client_id,client:ZAYAV.client_link,zayav_id:ZAYAV.id,arr:a.arr,func:cartridgeSchetSet})):b.loadError()},"json");break;case 5:_accrualAdd();break;case 6:_incomeAdd();
break;case 7:_refundAdd();break;case 8:_zayavExpenseEdit();break;case 9:_remindAdd()}}}))});
