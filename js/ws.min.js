...
$("#remind-day")._calendar()}));$("#zayav-cartridge").length&&($("#sort")._radio(cartridgeSpisok),$("#desc")._check(cartridgeSpisok),$("#status").rightLink(cartridgeSpisok),$("#paytype")._radio(cartridgeSpisok),$("#noschet")._check(cartridgeSpisok));$("#zayav-cartridge-info").length&&$("#zayav-action")._dropdown({head:"Действие",nosel:1,spisok:[{uid:1,title:"Редактировать заявку"},{uid:2,title:"<b>Распечатать квитанцию</b>"},{uid:3,title:"Сформировать счёт на оплату"},{uid:5,title:"Начислить"},{uid:6,
title:"<b>Принять платёж</b>"},{uid:7,title:"Возврат"},{uid:8,title:"Изменить расходы по заявке"},{uid:9,title:"Новое напоминание"}],func:function(a){switch(a){case 1:zayavCartridgeEdit();break;case 2:3==WS_ID&&(location.href=APP_HTML+"/view/kvit_cartridge.php?"+VALUES+"&id="+ZAYAV.id);break;case 3:if(!_checkAll()){_schetEdit({edit:1,client_id:ZAYAV.client_id,client:ZAYAV.client_link,zayav_id:ZAYAV.id});break}var b=_dialog({head:"Получение информации о картриджах",load:1,butSubmit:""});a={op:"zayav_cartridge_ids",
ids:_checkAll()};$.post(AJAX_MAIN,a,function(a){a.success?(b.close(),_schetEdit({edit:1,client_id:ZAYAV.client_id,client:ZAYAV.client_link,zayav_id:ZAYAV.id,arr:a.arr,func:cartridgeSchetSet})):b.loadError()},"json");break;case 5:_accrualAdd();break;case 6:_incomeAdd();break;case 7:_refundAdd();break;case 8:_zayavExpenseEdit();break;case 9:_remindAdd()}}})});
