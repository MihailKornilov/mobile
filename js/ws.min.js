...
title:"Возврат"},{uid:8,title:"Изменить расходы по заявке"},{uid:9,title:"Новое напоминание"}],func:function(a){switch(a){case 2:3==WS_ID&&(location.href=APP_HTML+"/view/kvit_cartridge.php?"+VALUES+"&id="+ZAYAV.id);break;case 3:_schetEdit({edit:1,client_id:ZAYAV.client_id,client:ZAYAV.client_link,zayav_id:ZAYAV.id});break;case 5:_accrualAdd();break;case 6:_incomeAdd();break;case 7:_refundAdd();break;case 8:_zayavExpenseEdit();break;case 9:_remindAdd()}}})});
