...
spisok:ZPNAME_SPISOK[a]})._select(b||0)},zpNameAdd=function(){function a(){var a={op:"zpname_add",device_id:ZPNAME.device_id,name:$("#name").val()};a.name?(b.process(),$.post(AJAX_SA,a,function(d){d.success?($(".sa-equip").length?$("#zp-spisok").html(d.zp):(ZPNAME_SPISOK[ZPNAME.device_id].push({uid:d.id,title:a.name}),$("#name_id")._select(ZPNAME_SPISOK[ZPNAME.device_id])._select(d.id)),b.close(),_msg("Внесено!")):b.abort()},"json")):(b.err("Не указана запчасть"),$("#name").focus())}var b=_dialog({width:390,
...
vendor_id:s.val(),model_id:r.val()}}a=$.extend({width:150,func:function(){},func_device:function(){},type_no:0,device_id:0,vendor_id:0,model_id:0,device_multiselect:0,device_ids:null,vendor_ids:null,model_ids:null,add:0,device_funcAdd:null,vendor_funcAdd:null,model_funcAdd:null},a);var l=$(this),h=l.attr("id"),u=["Производитель не выбран","Любой производитель"],v=["Модель не выбрана","Любая модель"],q;l.html('<input type="hidden" id="'+h+'_device" value="'+a.device_id+'"><input type="hidden" id="'+
...
$.fn.zayavExpense=function(a){function b(a){a||(a=[0,"",""]);var c=d+f,e=c+"cat",p=c+"worker",l=c+"zp";u.append('<table id="ptab'+f+'" class="ptab" val="'+f+'"><tr><td><input type="hidden" id="'+e+'" value="'+a[0]+'" /><td class="tddop">'+(a[0]&&ZE_TXT[a[0]]?'<input type="text" class="zetxt" placeholder="описание не указано" tabindex="'+(10*f-1)+'" value="'+a[1]+'" />':"")+(a[0]&&ZE_WORKER[a[0]]?'<input type="hidden" id="'+p+'" value="'+a[1]+'" />':"")+(a[0]&&ZE_ZP[a[0]]?'<input type="hidden" id="'+
l+'" value="'+a[1]+'" />':"")+'<td class="tdsum'+(a[0]?"":" dn")+'"><input type="text" class="zesum" maxlength="6" tabindex="'+10*f+'" value="'+a[2]+'" />руб.</table>');var m=$("#ptab"+f),h=m.find(".tddop"),g=m.find(".zesum");$("#"+e)._select({width:130,disabled:0,title0:"Категория",spisok:ZE_SPISOK,func:function(a){m.find(".tdsum")[(a?"remove":"add")+"Class"]("dn");ZE_TXT[a]?(h.html('<input type="text" class="zetxt" placeholder="описание не указано" tabindex="'+(10*f-11)+'" />'),h.find(".zetxt").focus()):
...
ZAYAV.imei+'"><tr><td class="label r">Серийный номер:<td><input type="text" id="serial" maxlength="30" value="'+ZAYAV.serial+'"><tr><td class="label r">Цвет:<td><input type="hidden" id="color_id" value="'+ZAYAV.color_id+'" /><span class="color_dop dn"><tt>-</tt><input TYPE="hidden" id="color_dop" value="'+ZAYAV.color_dop+'" /></span><tr class="tr_equip'+(ZAYAV.equip?"":" dn")+'"><td class="label r top">Комплектация:<td class="equip_spisok">'+ZAYAV.equip+'<tr><td class="label r">Диагностика:<td><input TYPE="hidden" id="diagnost" value="'+
...
colorSelDop(ZAYAV.color_id);$("#diagnost")._check()}).on("click","#zayav-info .schet-add",function(){function a(){for(var c="<tr><th>№<th>Наименование товара<th>Кол-во<th>Цена<th>Сумма<th>",d=0,l=0;l<f.length;l++)var h=f[l],g=h.cost*h.count,c=c+('<tr><td class="td-n">'+(l+1)+'<td class="td-name">'+h.name+'<td class="td-count">'+h.count+'<td class="td-cost">'+h.cost+'<td class="td-sum">'+g+"<td>"+(h.del?'<div val="'+l+'" class="img_del pole-del'+_tooltip("Удалить",-29)+"</div>":"")),d=d+g;e=l+1;c+=
'<tr><td colspan="6" class="_next" id="pole-add">Добавить позицию для счёта';$("#schet-tab").html(c);$("#itog").html("Всего наименований "+l+", на сумму "+d+" руб.");$("#pole-add").click(b);$(".pole-del").click(function(){f.splice(_num($(this).attr("val")),1);a()})}function b(){var a=$(this),b='<tr id="tr-add"><td class="td-n">'+e+'<td class="td-name"><input type="text" id="name" /><td class="td-count"><input type="text" id="count" value="1" /><td class="td-cost"><input type="text" id="cost" /><td><div class="vkButton"><button>OK</button></div><td><div class="img_del'+
_tooltip("Отменить",-32)+"</div>";a.parent().hide();$("#schet-tab").append(b);$("#name").focus();$("#tr-add .img_del").click(function(){$("#tr-add").remove();a.parent().show()});$("#tr-add .vkButton").click(c)}function c(){var b=$.trim($("#name").val()),c=_num($("#count").val()),e=_num($("#cost").val());b?c?e?(f.push({name:b,count:c,cost:e,del:1}),a()):(d("Некорректное количество"),$("#cost").focus()):(d("Некорректная сумма"),$("#count").focus()):(d("Не указано наименование"),$("#name").focus())}
function d(a){$("#name").vkHint({msg:'<span class="red">'+a+"</span>",remove:1,indent:40,show:1,top:-58,left:404})}$(this);var f,e,g=_dialog({top:20,width:580,head:"Формирование счёта",load:1,butSubmit:"Сформировать",submit:function(){var a={op:"zayav_cartridge_schet_add",zayav_id:ZAYAV.id,spisok:f,date_create:$("#date_create").val(),dop:_num($("#dop").val()),acc:_num($("#acc").val())};a.spisok.length?a.dop?(g.process(),$.post(AJAX_WS,a,function(a){a.success?($("#cart-tab").html(a.cart),$("#schet-spisok").html(a.schet),
...
id:b};c.process();$.post(AJAX_WS,a,function(a){a.success?(c.close(),$("#cart-tab").html(a.html),_msg("Удалено.")):c.abort()},"json")}})}).ready(function(){if($("#zayav").length){$("#find").vkHint({msg:"Поиск производится по<br />совпадению в названии<br />модели, imei и серийном<br />номере.",ugol:"right",top:-9,left:-178,delayShow:800})._search({width:153,focus:1,txt:"Быстрый поиск...",enter:1,func:zayavSpisok}).inp(Z.find);$("#desc")._check(zayavSpisok);$("#status").rightLink(zayavSpisok);$("#diagnost")._check(zayavSpisok);
$("#diff")._check(zayavSpisok);WORKER_SPISOK.push({uid:-1,title:"Не назначен",content:"<b>Не назначен</b>"});$("#executer")._select({width:155,title0:"не указан",spisok:WORKER_SPISOK,func:zayavSpisok});$("#dev").device({width:155,type_no:1,device_id:Z.device_id,vendor_id:Z.vendor_id,model_id:Z.model_id,device_multiselect:1,device_ids:Z.device_ids,vendor_ids:Z.vendor_ids,model_ids:Z.model_ids,func:zayavSpisok});for(var a=0;a<Z.place_other.length;a++){var b=Z.place_other[a];DEVPLACE_SPISOK.push({uid:encodeURI(b),
title:b})}DEVPLACE_SPISOK.push({uid:-1,title:"не известно",content:"<B>не известно</B>"});$("#device_place")._select({width:155,title0:"Любое местонахождение",spisok:DEVPLACE_SPISOK,func:zayavSpisok});Z.cookie_id&&(VK.callMethod("scrollWindow",_cookie("zback_scroll")),$("#u"+Z.cookie_id).css("opacity",0.1).delay(400).animate({opacity:1},700));zayavFilter()}$("#zayavAdd").length&&($("#client_id").clientSel({add:1}),$("#dev").device({width:190,add:1,device_ids:WS_DEVS,func:zayavDevSelect}),zayavPlace(),
colorSelDop(0),$("#comm").autosize(),$(".vkCancel").click(function(){location.href=URL+"&p="+$(this).attr("val")}),$(".vkButton").click(function(){if(!$(this).hasClass("busy")){var a={op:"zayav_add",client_id:$("#client_id").val(),device:$("#dev_device").val(),vendor:$("#dev_vendor").val(),model:$("#dev_model").val(),equip:"",place:$("#place").val(),place_other:$("#place_other").val(),imei:$("#imei").val(),serial:$("#serial").val(),color:$("#color_id").val(),color_dop:$("#color_dop").val(),diagnost:$("#diagnost").val(),
comm:$("#comm").val(),pre_cost:$("#pre_cost").val(),day_finish:$("#day_finish").val()};if(!$(".tr_equip").hasClass("dn")){for(var b=$(".equip_spisok input"),f=[],e=0;e<b.length;e++){var g=b.eq(e);1==g.val()&&f.push(g.attr("id").split("_")[1])}a.equip=f.join()}b="";0==a.client_id?b="Не выбран клиент":0==a.device?b="Не выбрано устройство":"-1"==a.place||0==a.place&&!a.place_other?b="Не указано местонахождение устройства":!a.pre_cost||REGEXP_NUMERIC.test(a.pre_cost)&&0!=a.pre_cost?"0000-00-00"==a.day_finish?
b="Не указан срок выполнения ремонта":(0<a.place&&(a.place_other=""),$(this).addClass("busy"),$.post(AJAX_WS,a,function(a){location.href=URL+"&p=zayav&d=info&id="+a.id},"json")):(b="Некорректно указана предварительная стоимость",$("#pre_cost").focus());b&&$(this).vkHint({msg:'<SPAN class="red">'+b+"</SPAN>",top:-48,left:201,indent:30,remove:1,show:1})}}));$("#zayav-info").length&&($(".hist").click(function(){$("#dopLinks .sel").removeClass("sel");$(this).addClass("sel");$(".itab").addClass("h")}),
$(".info").click(function(){$("#dopLinks .sel").removeClass("sel");$(this).addClass("sel");$(".itab").removeClass("h")}),$(".delete").click(function(){var a=_dialog({top:110,width:250,head:"Удаление заявки",content:"<center>Подтвердите удаление заявки.</center>",butSubmit:"Удалить",submit:function(){var b={op:"zayav_delete",zayav_id:ZAYAV.id};a.process();$.post(AJAX_WS,b,function(b){b.success?location.href=URL+"&p=client&d=info&id="+b.client_id:a.abort()},"json")}})}).vkHint({msg:"Заявку можно удалить при отсутствии платежей и начислений. Также удаляются все задачи к этой заявке.",
width:150,ugol:"top",top:39,left:457,indent:"right"}),$(".img_print").click(function(){function a(c){b.bottom.vkHint({msg:'<SPAN class="red">Не указана неисправность</SPAN>',top:c?-112:-47,left:c?127:97,indent:50,show:1,remove:1})}var b=_dialog({width:380,top:30,head:"Заявка №"+ZAYAV.nomer+" - Формирование квитанции",content:'<table class="zayav-print"><tr><td class="label">Дата приёма:<td>'+PRINT.dtime+'<tr><td class="label top">Устройство:<td>'+PRINT.device+'<tr><td class="label">Цвет:<td>'+(PRINT.color?
