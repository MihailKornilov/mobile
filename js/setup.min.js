...
submit:a});$("#name").focus().keyEnter(a);$("#types")._select({width:218,multiselect:1,spisok:INCOME_SPISOK})}).on("click","#setup_invoice .img_edit",function(){function a(){var a={op:"invoice_edit",id:e,name:$("#name").val(),about:$("#about").val(),types:$("#types").val()};a.name?(f.process(),$.post(AJAX_SETUP,a,function(a){a.success?($(".spisok").html(a.html),f.close(),_msg("Сохранено!")):(f.abort(),b(a.text))},"json")):(b("Не указано наименование"),$("#name").focus())}function b(b){f.bottom.vkHint({msg:"<SPAN class=red>"+
b+"</SPAN>",top:-47,left:100,indent:50,show:1,remove:1})}for(var c=$(this);"TR"!=c[0].tagName;)c=c.parent();var e=c.attr("val"),d=c.find(".name div").html(),g=c.find(".name pre").html(),c=c.find(".type_id").val(),f=_dialog({width:400,head:"Редактирование данных счёта",content:'<table class="setup-tab"><tr><td class="label r">Наименование:<td><input id="name" type="text" maxlength="100" value="'+d+'" /><tr><td class="label r top">Описание:<td><textarea id="about">'+g+'</textarea><tr><td class="label topi">Виды платежей:<td><input type="hidden" id="types" value="'+
...
content:'<table class="setup-tab"><tr><td class="label r">Наименование:<td><input id="name" type="text" maxlength="100" /></table>',submit:a});$("#name").focus().keyEnter(a)}).on("click","#setup_income .img_edit",function(){function a(){var b={op:"income_edit",id:c,name:$("#name").val()};b.name?(e.process(),$.post(AJAX_SETUP,b,function(b){b.success?($(".spisok").html(b.html),e.close(),_msg("Сохранено!"),sortable()):e.abort()},"json")):(e.bottom.vkHint({msg:"<SPAN class=red>Не указано наименование</SPAN>",
top:-47,left:131,indent:50,show:1,remove:1}),$("#name").focus())}for(var b=$(this);"DD"!=b[0].tagName;)b=b.parent();var c=b.attr("val"),b='<table class="setup-tab"><tr><td class="label r">Наименование:<td><input id="name" type="text" maxlength="100" value="'+b.find(".name").html()+'" /></table>',e=_dialog({width:440,head:"Редактирование вида платежа",content:b,butSubmit:"Сохранить",submit:a});$("#name").focus().keyEnter(a)}).on("click","#setup_income .img_del",function(){var a=$(this),b=_dialog({top:90,
...
submit:a});$("#name").focus().keyEnter(a);$("#show_worker")._check()}).on("click","#setup_expense .img_edit",function(){function a(){var b={op:"expense_edit",id:c,name:$("#name").val(),show_worker:$("#show_worker").val()};b.name?(d.process(),$.post(AJAX_SETUP,b,function(b){b.success?($("#spisok").html(b.html),d.close(),_msg("Сохранено!"),sortable()):d.abort()},"json")):(d.bottom.vkHint({msg:'<span class="red">Не указано наименование</span>',top:-47,left:131,indent:50,show:1,remove:1}),$("#name").focus())}
...
$("#show_worker")._check()}).on("click","#setup_expense .img_del",function(){var a=$(this),b=_dialog({top:90,head:"Удаление категории расхода мастерской",content:"<center><b>Подтвердите удаление.</b></center>",butSubmit:"Удалить",submit:function(){for(;"DD"!=a[0].tagName;)a=a.parent();var c={op:"expense_del",id:a.attr("val")};b.process();$.post(AJAX_SETUP,c,function(a){a.success?($("#spisok").html(a.html),b.close(),_msg("Удалено!"),sortable()):b.abort()},"json")}})}).on("click","#setup_zayav_expense .add",
function(){function a(){var a={op:"zayav_expense_add",name:$.trim($("#name").val()),dop:$("#dop").val()};a.name?(b.process(),$.post(AJAX_SETUP,a,function(a){a.success?($(".spisok").html(a.html),b.close(),_msg("Внесено!"),sortable()):b.abort()},"json")):(b.bottom.vkHint({msg:"<SPAN class=red>Не указано наименование</SPAN>",top:-47,left:131,indent:50,show:1,remove:1}),$("#name").focus())}$(this);var b=_dialog({width:440,head:"Добавление новой категории расхода заявки",content:'<table class="setup-tab"><tr><td class="label">Наименование:<td><input id="name" type="text" maxlength="50" /><tr><td class="label topi">Дополнительное поле:<td><input id="dop" type="hidden" /></table>',
