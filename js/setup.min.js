...
rules_historytransfer:$("#rules_historytransfer").val(),rules_money:$("#rules_money").val()},b=$(this);b.hasClass("busy")||(b.addClass("busy"),$.post(AJAX_SETUP,a,function(a){b.removeClass("busy");a.success&&_msg("Права сохранены.")},"json"))}),$(".dop-save").click(function(){var a={op:"worker_dop_save",viewer_id:RULES_VIEWER_ID,rules_getmoney:$("#rules_getmoney").val()},b=$(this);b.hasClass("busy")||(b.addClass("busy"),$.post(AJAX_SETUP,a,function(a){b.removeClass("busy");a.success&&_msg("Дополнительные настройки сохранены.")},
"json"))}))});
