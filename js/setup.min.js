...
a.abort()},"json")}})}).ready(function(){$("#setup_info").length&&$("#info_del").click(function(){var b=_dialog({top:150,width:300,head:"Удаление мастерской",content:"<center>Вы действительно хотите<BR>удалить мастерскую и все данные?</center>",butSubmit:"&nbsp;&nbsp;&nbsp;&nbsp;Да&nbsp;&nbsp;&nbsp;&nbsp;",submit:function(){b.process();$.post(AJAX_SETUP,{op:"info_del"},function(a){a.success?location.href=URL:b.abort()},"json")}})});$("#setup_rekvisit").length&&($("textarea").autosize(),$(".vkButton").click(function(){var b=
$(this),a={op:"rekvisit",org_name:$("#org_name").val(),ogrn:$("#ogrn").val(),inn:$("#inn").val(),kpp:$("#kpp").val(),adres_yur:$("#adres_yur").val(),telefon:$("#telefon").val(),adres_ofice:$("#adres_ofice").val(),schet:$("#schet").val(),bank_name:$("#bank_name").val(),bik:$("#bik").val(),kor_schet:$("#kor_schet").val()};b.addClass("busy");$.post(AJAX_SETUP,a,function(a){b.removeClass("busy");a.success&&_msg("Информация сохранена.")},"json")}));$("#setup-service").length&&$(".s-cartridge-toggle").click(function(){for(var b=
$(this),a=b,c={op:"cartridge_toggle",v:b.hasClass("off")?0:1};!a.hasClass("unit");)a=a.parent();var e=a.find("h1");e.hasClass("_busy")||(e.addClass("_busy"),$.post(AJAX_SETUP,c,function(b){e.removeClass("_busy");b.success&&(a[(c.v?"add":"remove")+"Class"]("on"),_msg("Выполнено!"))},"json"))});$("#setup_rules").length&&($(".g-save").click(function(){function b(a){c.vkHint({msg:'<SPAN class="red">'+a+"</SPAN>",top:-57,left:-6,indent:40,show:1,remove:1})}var a={op:"worker_name_save",viewer_id:RULES_VIEWER_ID,
first_name:$("#first_name").val(),last_name:$("#last_name").val(),post:$("#post").val()},c=$(this);a.first_name?a.last_name?(c.addClass("busy"),$.post(AJAX_SETUP,a,function(a){c.removeClass("busy");a.success&&_msg("Сохранено.")},"json")):(b("Не указана фамилия"),$("#last_name").focus()):(b("Не указано имя"),$("#first_name").focus())}),$("#rules_appenter")._check(function(b){$(".app-div")[(0==b?"add":"remove")+"Class"]("dn");$("#rules_info")._check(0);$("#rules_worker")._check(0);$("#rules_rules")._check(0);
$("#rules_income")._check(0);$("#rules_historyshow")._check(0);$("#rules_money")._dropdown(0)}),$("#rules_money")._dropdown({spisok:[{uid:0,title:"только свои"},{uid:1,title:"все платежи"}]}),$(".rules-save").click(function(){var b={op:"worker_rules_save",viewer_id:RULES_VIEWER_ID,rules_appenter:$("#rules_appenter").val(),rules_info:$("#rules_info").val(),rules_worker:$("#rules_worker").val(),rules_rules:$("#rules_rules").val(),rules_income:$("#rules_income").val(),rules_historyshow:$("#rules_historyshow").val(),
rules_historytransfer:$("#rules_historytransfer").val(),rules_money:$("#rules_money").val()},a=$(this);a.hasClass("busy")||(a.addClass("busy"),$.post(AJAX_SETUP,b,function(b){a.removeClass("busy");b.success&&_msg("Права сохранены.")},"json"))}),$(".dop-save").click(function(){var b={op:"worker_dop_save",viewer_id:RULES_VIEWER_ID,rules_money_procent:$("#rules_money_procent").val()},a=$(this);a.hasClass("busy")||(a.addClass("busy"),$.post(AJAX_SETUP,b,function(b){a.removeClass("busy");b.success&&_msg("Дополнительные настройки сохранены.")},
"json"))}))});
