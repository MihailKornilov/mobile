$(document).on("click","#setup_info #devs div",function(){function b(b,c){$("#devs span").remove();a.prepend("<span><em"+(c?' class="err"':"")+">"+b+"</em></span>").find("span").delay(1500).fadeOut(1500,function(){$(this).remove()})}for(var a=$(this),c=a.parent().find("input"),d=[],e=0;e<c.length;e++){var f=c.eq(e);1==f.val()&&d.push(f.attr("id"))}d.length?(c={op:"info_devs_set",devs:d.join()},$.post(AJAX_MAIN,c,function(a){a.success&&b("Изменения сохранены")},"json")):b("Не сохранено!<br />Необходимо выбрать<br />минимум одну категорию",
...
b,function(a){a.success?($("#spisok").html(a.html),CARTRIDGE_SPISOK=a.cart,g.close(),_msg("Изменено!")):g.abort()},"json")):(g.err("Не указано наименование"),$("#name").focus())}for(var a=$(this),c=a.attr("val");"TR"!=a[0].tagName;)a=a.parent();var d=a.find(".name").html(),e=a.find(".type_id").val(),f=a.find(".filling").val(),h=a.find(".restore").val(),a=a.find(".chip").val(),g=_dialog({top:40,width:400,head:"Редактирование данных картриджа",content:'<table class="setup-tab"><tr><td class="label">Вид:<td><input type="hidden" id="type_id" value="'+
e+'" /><tr><td class="label"><b>Модель картриджа:</b><td><input type="text" id="name" value="'+d+'" /><tr><td class="label">Заправка:<td><input type="text" id="cost_filling" class="money" maxlength="11" value="'+f+'" /> руб.<tr><td class="label">Восстановление:<td><input type="text" id="cost_restore" class="money" maxlength="11" value="'+h+'" /> руб.<tr><td class="label">Замена чипа:<td><input type="text" id="cost_chip" class="money" maxlength="11" value="'+a+'" /> руб.<tr><td><td><tr><td class="label">Объединить:<td><input type="hidden" id="join" /><tr class="tr-join dn"><td class="label">С картриджем:<td><input type="hidden" id="join_id" /></table>',
butSubmit:"Сохранить",submit:b});$("#type_id")._select({spisok:CARTRIDGE_TYPE});$("#name").focus();$("#name,#cost_filling,#cost_restore,#cost_chip").keyEnter(b);$("#join")._check({func:function(a){$(".tr-join")[(a?"remove":"add")+"Class"]("dn")}});d=[];for(e=0;e<CARTRIDGE_SPISOK.length;e++)f=CARTRIDGE_SPISOK[e],f.uid!=c&&d.push(f);$("#join_id")._select({width:218,write:1,title0:"Не выбрано",spisok:d})}).on("mouseleave","#setup-service-cartridge .edited",function(){$(this).css("background-color","#fff")}).ready(function(){$("#setup_info").length&&
...
submit:function(){b.process();$.post(AJAX_MAIN,{op:"info_del"},function(a){a.success?location.href=URL:b.abort()},"json")}})}));$("#setup-service").length&&$(".s-cartridge-toggle").click(function(){for(var b=$(this),a=b,c={op:"cartridge_toggle",v:b.hasClass("off")?0:1};!a.hasClass("unit");)a=a.parent();var d=a.find("h1");d.hasClass("_busy")||(d.addClass("_busy"),$.post(AJAX_MAIN,c,function(b){d.removeClass("_busy");b.success&&(a[(c.v?"add":"remove")+"Class"]("on"),_msg("Выполнено!"))},"json"))})});
