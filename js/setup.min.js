...
b,function(a){a.success?($("#spisok").html(a.html),CARTRIDGE_SPISOK=a.cart,g.close(),_msg("Изменено!")):g.abort()},"json")):(g.err("Не указано наименование"),$("#name").focus())}for(var a=$(this),c=a.attr("val");"TR"!=a[0].tagName;)a=a.parent();var e=a.find(".name").html(),d=a.find(".type_id").val(),f=a.find(".filling").val(),h=a.find(".restore").val(),a=a.find(".chip").val(),g=_dialog({top:40,width:400,head:"Редактирование данных картриджа",content:'<table id="setup-tab"><tr><td class="label">Вид:<td><input type="hidden" id="type_id" value="'+
