...
".sa-zpname .img_del",function(){var a=$(this),b=_dialog({top:90,width:300,head:"Удаление",content:"<center><b>Подтвердите удаление наименования запчасти.</b></center>",butSubmit:"Удалить",submit:function(){for(;"TR"!=a[0].tagName;)a=a.parent();var c={op:"zpname_del",id:a.attr("val")};b.process();$.post(AJAX_SA,c,function(a){a.success?($(".spisok").html(a.html),b.close(),_msg("Удалено!")):b.abort()},"json")}})}).ready(function(){0<$(".sa-model").length&&(window.find=$("#find")._search({width:300,
