...
($(".spisok").html(a.html),b.close(),_msg("Удалено!")):b.abort()},"json")}})}).ready(function(){0<$(".sa-model").length&&(window.find=$("#find")._search({width:300,txt:"Поиск по названию модели",enter:1,focus:1,func:function(a){var b=$(".path");b.hasClass("busy")||(a={op:"model_load",vendor_id:VENDOR_ID,find:a},b.addClass("busy"),$.post(AJAX_SA,a,function(a){b.removeClass("busy");a.success&&$("._spisok").find(".tr").remove().end().append(a.html)},"json"))}}))});
